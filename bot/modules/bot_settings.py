...
DEFAULT_DESP = {
    ...
    "SOCIAL_AUTO_DOWNLOAD": "Automatically download Instagram and Twitter/X media links posted in allowed chats. Default: False.",
    "SOCIAL_AUTO_DOWNLOAD_CHATS": "Space-separated Chat/User IDs where Social Auto-Download is active. Empty = all authorized chats.",
    ...
    "MEDIA_SPLIT": "Use FFmpeg for video splitting (.part001.mkv). Default: True.",
